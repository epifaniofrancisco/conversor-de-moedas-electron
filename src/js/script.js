...
exchangeIcon.addEventListener("click", ()=>{
    ...
    loadFlag(countryList, fromCurrency); // calling loadFlag with passing select element (fromCurrency) of FROM
    loadFlag(countryList, toCurrency); // calling loadFlag with passing select element (toCurrency) of TO
